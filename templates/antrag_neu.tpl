...
<script type="text/javascript">
    ...
    $('#btnKapitalwert').click(function ()
    {
        ...
        var structure = "<tr><td><input disabled name='reg[kapitalwerte][kwJahr"+tableKapitalwertVal+"]' value='"+tableKapitalwertVal+"' /></td><td><input type='number' placeholder='Ausgaben' name='reg[kwAusg"+tableKapitalwertVal+"]'/></td><td><input type='number' placeholder='Einnahmen' name='reg[kwEin"+tableKapitalwertVal+"]'</td></tr>"
