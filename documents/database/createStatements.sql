...
CREATE TABLE IF NOT EXISTS Projekt(
  ...
  risiko VARCHAR(255),
  e_id INT(6) UNSIGNED,
  FOREIGN KEY(e_id) REFERENCES Mitarbeiter(id) ON DELETE CASCADE ON UPDATE CASCADE,
  a_id INT(6) UNSIGNED,
  FOREIGN KEY(a_id) REFERENCES Abteilung(id) ON DELETE CASCADE ON UPDATE CASCADE,
  l_id INT(6) UNSIGNED,
  FOREIGN KEY(l_id) REFERENCES Mitarbeiter(id) ON DELETE CASCADE ON UPDATE CASCADE,
  b_id INT(6) UNSIGNED,
  FOREIGN KEY(b_id) REFERENCES Mitarbeiter(id) ON DELETE CASCADE ON UPDATE CASCADE,
  s_id INT(6) UNSIGNED,
  FOREIGN KEY(s_id) REFERENCES ProjStatus(id) ON DELETE CASCADE ON UPDATE CASCADE,
  vor_sta_term DATE,
  vor_end_term DATE,
  tat_sta_term DATE,
  tat_end_term DATE,
...
CREATE TABLE IF NOT EXISTS ProjTeam(
  ...
  FOREIGN KEY(t_id) REFERENCES Team(id) ON DELETE CASCADE ON UPDATE CASCADE,
  p_id INT(6) UNSIGNED NOT NULL,
  FOREIGN KEY(p_id) REFERENCES Projekt(id) ON DELETE CASCADE ON UPDATE CASCADE,
